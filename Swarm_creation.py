...
commands = [
    ...
    "mavproxy.py --master tcp:127.0.0.1:5760 --out udp:127.0.0.1:14540 --out udp:172.17.192.1:14551",
    "mavproxy.py --master tcp:127.0.0.1:5770 --out udp:127.0.0.1:14541 --out udp:172.17.192.1:14552",
